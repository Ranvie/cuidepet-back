...
class AnnouncementRequest extends FormRequest {
  ...
  private function postRules() :array {
    return [
      ...
      'contactPhone'             => ['required_without:contactEmail', 'nullable', 'string', new PhoneRule()],
      'contactEmail'             => ['required_without:contactPhone', 'nullable', 'string', 'email', 'max:255'],
      ...
      'formId'                   => 'nullable|int|exists:tb_form,id',
